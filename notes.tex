...
\begin{defn}
  DFA $(Q, \Sigma, \delta, q_{0}, F)$ accepts a string $w = w_1 w_2 \dots w_n$ iff
  \[
...
\begin{eg}
  Language: $\left \{ w : w = \underbrace{\verb~00...0~}_{\geq 0}\underbrace{\verb~11...1~}{\geq 0}\underbrace{\verb~00...0~}{\geq 1} \right \}$ % >= 0, >= 0, >= 1
