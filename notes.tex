...
\begin{eg}
  ...
  \begin{minipage}{0.45 \textwidth}
    \begin{center}
      \Tree[.$P$ [.$P$ \verb~a~ \verb~b~ ] [.$P$ [.$P$ \verb~a~ \verb~b~ ] [.$P$ \verb~a~ \verb~b~ ]]]
    \end{center}
  \end{minipage}%
  \hspace*{\fill}%
  \begin{minipage}{0.45 \textwidth}
...
\begin{eg}
  ...
  \begin{enumerate}
    \item the balance starts at 0 and ends at 0, and where

    \item the balance starts at 0 and ends up positive.
  \end{enumerate}
  ...
  \begin{center}
    \begin{tikzpicture}[scale = 0.75]
      \begin{axis}[
        ...
        \addplot[no marks, very thick, domain = 4 : 6]{6 - x};
        \addplot[no marks, very thick, domain = 6 : 9]{x - 6};
        \addplot[red, very thick, dashed] (7, -2) to (7, 6);
        \addplot[no marks, very thick, domain = 9 : 11]{12 - x};
        \addplot[no marks, very thick, domain = 11 : 12]{x - 10};
        \addplot[no marks, very thick, domain = 12 : 13]{14 - x};
        \addplot[red, very thick, dashed] (13, -2) to (13, 6);
        \addplot[no marks, very thick, domain = 13 : 15]{x - 12};
        \addplot[no marks, very thick, domain = 15 : 16]{18 - x};
      \end{axis}
    \end{tikzpicture}
  ...
  \[
    S \to {\color{red} \underbrace{\color{black} \varepsilon \; | \; P}_{\text{case 1}}} \; | \; {\color{red} \underbrace{\color{black} \verb~a~ P \; | \; P \verb~a~ S}_{\text{case 2}}}.
  \]
\end{eg}
...
\begin{lem}[Pumping lemma for regular languages]
...
\begin{tikzpicture}[overlay, remember picture]
  \draw[curly] (pic cs:10.1.2a) -- (pic cs:10.1.2b) node[midway, above = 5] {$\leq p$};
\end{tikzpicture}
